...
// Input capabilities
const { localTestCapabilities } = require('../conf');
...
async function runTestWithCaps () {
  let driver = new webdriver.Builder().usingServer(`https://hub-cloud.browserstack.com/wd/hub`).withCapabilities(localTestCapabilities).build();
